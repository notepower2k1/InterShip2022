...
// Gọi chỗ này bắt buộc phải gọi 1 cái property bên PostList.js
// VD: {data, user}, bên kia <Post key={index} data={post}, user={currentUser}/>
const Post = ({ data, render }) => { 
                                ...
                                <ul>
                                    {
                                        data.isLiked 
                                        ?
                                            <li><i className="fa fa-thumbs-up" style={{color:'red'}} ></i></li>
                                        :
                                            <li><i className="fa fa-thumbs-up" style={{color:'blue'}}></i></li>
                                    }
                                    ...
                                    <li><a><span> {totalLikes} Likes</span></a></li>
